...
// specialization for LorentzVector and derivates
template<class T>
class ValueWithSystematics<T, typename std::enable_if<std::is_base_of<LorentzVector, T>::value>::type>: public ValueWithSystematicsInternal<T>
{
  public:
