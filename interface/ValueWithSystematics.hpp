...
//Include not needed, because the h is including this one, thus ensuring they are both always present
...
//****************** LorentzVector *****************************************************************
template<class T>
ValueWithSystematics<double> ValueWithSystematics<T, typename std::enable_if<std::is_base_of<LorentzVector, T>::value>::type>::Pt() const
{
  ValueWithSystematics<double> retVal = value.Pt();
...
template<class T>
ValueWithSystematics<double> ValueWithSystematics<T, typename std::enable_if<std::is_base_of<LorentzVector, T>::value>::type>::Phi() const
{
  ValueWithSystematics<double> retVal = value.Phi();
...
template<class T>
template<class U>
ValueWithSystematics<double> ValueWithSystematics<T, typename std::enable_if<std::is_base_of<LorentzVector, T>::value>::type>::DeltaR(const ValueWithSystematics<U>& other) const
{
...
template<class T>
ValueWithSystematics<TLorentzVector> ValueWithSystematics<T, typename std::enable_if<std::is_base_of<LorentzVector, T>::value>::type>::ToTLorentzVector() const
{
