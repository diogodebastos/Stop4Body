...
c1->SaveAs((path17+dm+"/ShapeComparison"+"/BDTyears_dm"+dm+title+"_"+variable+".pdf").c_str());
}

void loopShapeProcVarYears(){
  for(int i=10; i <= 80; i = i+10){
    cout<< "Doing DM: " <<i<<endl;
    cout << "== WJets" << endl;
    ShapeProcVarYears(i,true,false,false);
    cout << "== TTbar" << endl;
    ShapeProcVarYears(i,false,true,false);
    cout << "== Signal" << endl;
    ShapeProcVarYears(i,false,false,true);
  } 
}
