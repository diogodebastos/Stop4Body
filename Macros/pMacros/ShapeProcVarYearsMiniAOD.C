...
else if(variable == "LepChg"){
  Xbin=20;
  Xmin=-1.1;
  Xmax=1.1;
}
else if(variable == "DrJetHBLep"){
  Xbin=40;
  Xmin=0;
  Xmax=4.0;
}
else if(variable == "JetHBCSV"){
  Xbin=20;
  Xmin=0;
  Xmax=1.0;
}
else if(variable == "JetHBpt"){
  Xbin=34;
  Xmin=30.0;
  Xmax=710.0;
}
...
if(doWjets){
  hs->SetTitle((variable+"_dm"+dm+title).c_str());
...
if(doTTbar){
  ...
  tbdt->SetTitle((variable+"_dm"+dm+title).c_str());
...
if(doSignal){
  ...
  sbdt->SetTitle((variable+"_dm"+dm+title).c_str());
