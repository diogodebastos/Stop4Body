...
const Double_t Xmax=50.;

TH1F *tt = new TH1F("tt","t#bar{t};p_{T}(l) [GeV]",Xbin,Xmin,Xmax);
TT.Draw("LepPt>>tt",presel);
double ttn = tt->GetEntries();
tt->Scale(1./ttn);
tt->SetFillColor(kGray);
//tt->SetLineWidth(2);
TH1F *dm1 = new TH1F("dm1","Signal=(300,290);p_{T}(l) [GeV]",Xbin,Xmin,Xmax);
DM1.Draw("LepPt>>dm1",presel);
double tn = dm1->GetEntries();
dm1->Scale(1./tn);
dm1->SetLineColor(kRed);
dm1->SetLineWidth(2);
TH1F *dm2 = new TH1F("dm2","Signal=(300,270);p_{T}(l) [GeV]",Xbin,Xmin,Xmax);
DM2.Draw("LepPt>>dm2",presel);
double sn = dm2->GetEntries();
dm2->Scale(1./sn);
dm2->SetLineColor(kRed+1);
dm2->SetLineWidth(2);
TH1F *dm3 = new TH1F("dm3","Signal=(300,250);p_{T}(l) [GeV]",Xbin,Xmin,Xmax);
DM3.Draw("LepPt>>dm3",presel);
double w1n = dm3->GetEntries();
dm3->Scale(1./w1n);
dm3->SetLineColor(kRed+3);
dm3->SetLineWidth(2);
TH1F *dm4 = new TH1F("dm4","Signal=(300,220);p_{T}(l) [GeV]",Xbin,Xmin,Xmax);
DM4.Draw("LepPt>>dm4",presel);
