...
const Double_t Xmax=1200.;

TH1F *dm1 = new TH1F("dm1","MET",Xbin,Xmin,Xmax);
 DM1.Draw("Met>>dm1",presel);
double tn = dm1->GetEntries();
dm1->Scale(1./tn);
dm1->SetLineColor(1);
dm1->SetLineWidth(2);
TH1F *dm2 = new TH1F("dm2","MET",Xbin,Xmin,Xmax);
 DM2.Draw("Met>>dm2",presel);
double sn = dm2->GetEntries();
dm2->Scale(1./sn);
dm2->SetLineColor(2);
dm2->SetLineWidth(2);
TH1F *dm3 = new TH1F("dm3","MET",Xbin,Xmin,Xmax);
 DM3.Draw("Met>>dm3",presel);
double w1n = dm3->GetEntries();
dm3->Scale(1./w1n);
dm3->SetLineColor(3);
dm3->SetLineWidth(2);
TH1F *dm4 = new TH1F("dm4","MET",Xbin,Xmin,Xmax);
