...
TH1F *ht = new TH1F("ht","pT(Jet1)",Xbin,Xmin,Xmax);
TT.Draw("Jet1Pt>>ht");
double tn = ht->GetEntries();
ht->Scale(1./tn);
ht->SetLineColor(1);
ht->SetLineWidth(2);
TH1F *hs = new TH1F("hs","pT(Jet1)",Xbin,Xmin,Xmax);
S1.Draw("Jet1Pt>>hs");
double sn = hs->GetEntries();
hs->Scale(1./sn);
hs->SetLineColor(2);
hs->SetLineWidth(2);
TH1F *hw1 = new TH1F("hw1","pT(Jet1)",Xbin,Xmin,Xmax);
W1.Draw("Jet1Pt>>hw1");
double w1n = hw1->GetEntries();
hw1->Scale(1./w1n);
hw1->SetLineColor(3);
hw1->SetLineWidth(2);
TH1F *hw2 = new TH1F("hw2","pT(Jet1)",Xbin,Xmin,Xmax);
W2.Draw("Jet1Pt>>hw2");
double w2n = hw2->GetEntries();
hw2->Scale(1./w2n);
hw2->SetLineColor(4);
hw2->SetLineWidth(2);
TH1F *hw3 = new TH1F("hw3","pT(Jet1)",Xbin,Xmin,Xmax);
W3.Draw("Jet1Pt>>hw3");
double w3n = hw3->GetEntries();
hw3->Scale(1./w3n);
hw3->SetLineColor(5);
hw3->SetLineWidth(2);
TH1F *hw4 = new TH1F("hw4","pT(Jet1)",Xbin,Xmin,Xmax);
W4.Draw("Jet1Pt>>hw4");
...
hw4->Draw("same");
 ...
 lg->Draw();
 c1->SaveAs("ShapeJet1PT_300-270.pdf");
