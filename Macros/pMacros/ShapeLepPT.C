...
TH1F *ht = new TH1F("ht","pT(l)",Xbin,Xmin,Xmax);
TT.Draw("LepPt>>ht");
double tn = ht->GetEntries();
ht->Scale(1./tn);
ht->SetLineColor(1);
ht->SetLineWidth(2);
TH1F *hs = new TH1F("hs","pT(l)",Xbin,Xmin,Xmax);
S1.Draw("LepPt>>hs");
double sn = hs->GetEntries();
hs->Scale(1./sn);
hs->SetLineColor(2);
hs->SetLineWidth(2);
TH1F *hw1 = new TH1F("hw1","pT(l)",Xbin,Xmin,Xmax);
W1.Draw("LepPt>>hw1");
double w1n = hw1->GetEntries();
hw1->Scale(1./w1n);
hw1->SetLineColor(3);
hw1->SetLineWidth(2);
TH1F *hw2 = new TH1F("hw2","pT(l)",Xbin,Xmin,Xmax);
W2.Draw("LepPt>>hw2");
double w2n = hw2->GetEntries();
hw2->Scale(1./w2n);
hw2->SetLineColor(4);
hw2->SetLineWidth(2);
TH1F *hw3 = new TH1F("hw3","pT(l)",Xbin,Xmin,Xmax);
W3.Draw("LepPt>>hw3");
double w3n = hw3->GetEntries();
hw3->Scale(1./w3n);
hw3->SetLineColor(5);
hw3->SetLineWidth(2);
TH1F *hw4 = new TH1F("hw4","pT(l)",Xbin,Xmin,Xmax);
W4.Draw("LepPt>>hw4");
...
hw4->Draw("same");
 ...
 lg->Draw();
 c1->SaveAs("ShapeLepPT_300-270.pdf");
