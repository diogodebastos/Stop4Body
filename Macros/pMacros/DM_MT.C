...
TH1F *dm1 = new TH1F("dm1","Signal=(250,220);M_{T} [GeV]",Xbin,Xmin,Xmax);
...
dm2->SetLineColor(2);
dm2->SetLineWidth(2);
TH1F *dm3 = new TH1F("dm3","Signal=(400,370); M_{T} [GeV]",Xbin,Xmin,Xmax);
 DM3.Draw("mt>>dm3",presel);
double w1n = dm3->GetEntries();
dm3->Scale(1./w1n);
dm3->SetLineColor(3);
dm3->SetLineWidth(2);
TH1F *dm4 = new TH1F("dm4","Signal=(500,470); M_{T} [GeV]",Xbin,Xmin,Xmax);
