...
TChain TT("bdttree");
TT.Add("/lstore/cms/cbeiraod/Stop4Body/nTuples_v2017-10-19_test_skimmed/Wjets_600to800_skimmed.root");
...
const Int_t Xbin=6;
const Double_t Xmin=-2.5;
const Double_t Xmax=3.5;

TH1F *tt = new TH1F("tt","Wjets;Charge(l)",Xbin,Xmin,Xmax);
TT.Draw("LepChg>>tt",presel);
double ttn = tt->GetEntries();
tt->Scale(1./ttn);
tt->SetFillColor(kGray);
//tt->SetLineWidth(2);
TH1F *dm1 = new TH1F("dm1","Signal=(300,290);Charge(l)",Xbin,Xmin,Xmax);
DM1.Draw("LepChg>>dm1",presel);
double tn = dm1->GetEntries();
dm1->Scale(1./tn);
dm1->SetLineColor(kRed);
dm1->SetLineWidth(2);
TH1F *dm2 = new TH1F("dm2","Signal=(300,270);Charge(l)",Xbin,Xmin,Xmax);
DM2.Draw("LepChg>>dm2",presel);
double sn = dm2->GetEntries();
dm2->Scale(1./sn);
dm2->SetLineColor(kRed+1);
dm2->SetLineWidth(2);
TH1F *dm3 = new TH1F("dm3","Signal=(300,250);Charge(l)",Xbin,Xmin,Xmax);
DM3.Draw("LepChg>>dm3",presel);
double w1n = dm3->GetEntries();
dm3->Scale(1./w1n);
dm3->SetLineColor(kRed+3);
dm3->SetLineWidth(2);
TH1F *dm4 = new TH1F("dm4","Signal=(300,220);Charge(l)",Xbin,Xmin,Xmax);
DM4.Draw("LepChg>>dm4",presel);
