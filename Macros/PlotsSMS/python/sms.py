...
class sms():
    ...
    def _setDefault(self):
        ...
        self.boxOn = False
        self.extraTexts = [ 
                            #{'text':'CC' ,       'position':[0.78,0.79] ,'size':0.036 , 'align':32  , 'font':52},
                            {'text':'MVA' ,       'position':[0.78,0.79] ,'size':0.036 , 'align':32  , 'font':52},
                            {'text':'approach' , 'position':[0.78,0.75]  ,'size':0.036 , 'align':32 , 'font':52},
                            #{'text':'CC' ,       'position':[0.66,0.79]  ,'size':0.036 , 'align':12  , 'font':52},
                            #{'text':'approach' , 'position':[0.66,0.75]  ,'size':0.036 , 'align':12 , 'font':52},
                          ]
