...
def createJSON(stop,neutralino):
    ...
    with open(outputDirectory + "/Sig_"+stop+"_"+neutralino+".json", 'w') as thisJSON:
        ...
        thisJSON.write("            {\n")
        thisJSON.write("              \"path\":\"/gstore/t3cms/store/user/dchasque/Stop4Body17/Fall17ProdNov10/ProdNov10/SMS_T2tt_dM_10to80_genHT_160_genMET_80_mWMin_0p1\",\n")
        thisJSON.write("              \"split\":348\n")
        thisJSON.write("            },\n")
        thisJSON.write("            {\n")
