...
if [ ${YEAR} == 2016 ]; then
 ...
 mergeJSONs $JSON_PATH/plot2017-fake.json      $JSON_PATH/DataJetHT.json $JSON_PATH/ZInv.json $JSON_PATH/Wjets.json $JSON_PATH/Orig/DYJets.json $JSON_PATH/ttX.json $JSON_PATH/TTbar.json $JSON_PATH/Orig/QCD.json 
