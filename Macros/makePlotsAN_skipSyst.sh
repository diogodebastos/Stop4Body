...
if [[ -d ${INPUT} ]] ; then
  ...
  makePlots --json ${JSON_PATH}/plot${YEAR}-inj-2SPs.json --outDir ${OUTPUT}/DataMC/AR/ --inDir ${INPUT_TEST}/ --variables ${VARIABLE_JSON} --cuts ${JSONFILE} --skipSyst
  #makeTwoDPlots --json ${JSON_PATH}/plot${YEAR}_lep.json --outDir ${OUTPUT}/Corr/AR/ --inDir ${INPUT_TEST}/ --variables ${VARIABLE_JSON} --cuts ${JSONFILE} --skipSyst

  JSONFILE=variablesAN_DataMC_LNT.json
  makePlots --json ${JSON_PATH}/plot${YEAR}-inj-2SPs.json --outDir ${OUTPUT}/DataMC/LNT/ --inDir ${INPUT}/ --variables ${VARIABLE_JSON} --cuts ${JSONFILE} --skipSyst
  ...
  makePlots --json ${JSON_PATH}/plot${YEAR}_lep_Sig300_270.json --outDir ${OUTPUT}/DataMC/VR2/ --inDir ${INPUT}/ --variables ${VARIABLE_JSON} --cuts ${JSONFILE} --skipSyst
  #makeTwoDPlots --json ${JSON_PATH}/plot${YEAR}_lep.json --outDir ${OUTPUT}/Corr/VR2/ --inDir ${INPUT}/ --variables ${VARIABLE_JSON} --cuts ${JSONFILE} --skipSyst

  JSONFILE=variablesAN_DataMC_VR3.json
  makePlots --json ${JSON_PATH}/plot${YEAR}_lep_Sig300_270.json --outDir ${OUTPUT}/DataMC/VR3/ --inDir ${INPUT}/ --variables ${VARIABLE_JSON} --cuts ${JSONFILE} --skipSyst
  #makeTwoDPlots --json ${JSON_PATH}/plot${YEAR}_lep.json --outDir ${OUTPUT}/Corr/VR3/ --inDir ${INPUT}/ --variables ${VARIABLE_JSON} --cuts ${JSONFILE} --skipSyst

  JSONFILE=variables_forDDTable.json
  makePlots --json ${JSON_PATH}/plot${YEAR}_lep_Sig300_270.json --outDir ${OUTPUT}/BDT/CRs/ --inDir ${INPUT_TEST}_bdt30/ --variables ${JSONFILE} --cuts ${JSONFILE} --suffix bdt --skipSyst
  ...
  for deltaM in 10 20 30 40 50 60 70 80; do
    ...
    makePlots --json ${JSON_PATH}/plot${YEAR}_DM${deltaM}RP.json --outDir ${OUTPUT}/BDT/DeltaM${deltaM}/AR --inDir ${INPUT_TEST}_bdt${deltaM}/ --variables ${VARIABLE_JSON} --cuts ${JSONFILE} --suffix bdt --skipSyst
    ...
    makePlots --json ${JSON_PATH}/plot${YEAR}_DM${deltaM}RP.json --outDir ${OUTPUT}/BDT/DeltaM${deltaM}/VR2 --inDir ${INPUT}_bdt${deltaM}/ --variables ${VARIABLE_JSON} --cuts ${JSONFILE} --suffix bdt --unblind --skipSyst

    JSONFILE=variablesAN_BDT_VR3.json
    makePlots --json ${JSON_PATH}/plot${YEAR}_DM${deltaM}RP.json --outDir ${OUTPUT}/BDT/DeltaM${deltaM}/VR3 --inDir ${INPUT}_bdt${deltaM}/ --variables ${VARIABLE_JSON} --cuts ${JSONFILE} --suffix bdt --unblind --skipSyst
  done
fi
