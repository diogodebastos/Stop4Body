...
BDTStudy --json ${JSON_PATH}/plot2016swap.json     --outDir ${OUTPUTS}     --inDir ${INPUTS} --suffix bdt
BDTStudy --json ${JSON_PATH}/plot2016swap_pow.json --outDir ${OUTPUTS_POW} --inDir ${INPUTS} --suffix bdt
BDTStudy --json ${JSON_PATH}/plot2016swap_lep.json --outDir ${OUTPUTS_LEP} --inDir ${INPUTS} --suffix bdt
