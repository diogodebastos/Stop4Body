...
int main(int argc, char** argv)
{
  ...
  if(cutsJson == "")
  {
    ...
    cutFlow.push_back(CutInfo("ElFS_Selection", "(DPhiJet1Jet2 < 2.5 || Jet2Pt < 60) && (HT > 200) && (Met > 280) && (Jet1Pt > 110) && (nGoodEl <= 2) && (nGoodMu = 0)"));
    cutFlow.push_back(CutInfo("MuFS_Selection", "(DPhiJet1Jet2 < 2.5 || Jet2Pt < 60) && (HT > 200) && (Met > 280) && (Jet1Pt > 110) && (nGoodMu <= 2) && (nGoodEl = 0)"));
