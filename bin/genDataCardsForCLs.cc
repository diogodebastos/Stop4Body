...
int main(int argc, char** argv)
{
  ...
  std::string outputDirectory = "DataCards";
  std::string suffix = "";
  bool verbose = false;
  bool isHighDM = false;
  bool unblind = false;
